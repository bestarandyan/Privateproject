...
Vector imgVec;
private CanvasPhotoActivity can;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	bt4=(Button) findViewById(R.id.picture_yulan);
	 intent=getIntent();
	  in=intent.getIntExtra("btnvalue", 0);
	 switch(in){
	 case 1:
	...
	bt2.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			if(in == 81 || in == 82 || in == 83){
				intent1 = new Intent(PictureInfo.this,ElectrolCarXian.class);
			}else if(in == 84){
				intent1 = new Intent(PictureInfo.this,ElectronCaiChan.class);
			}else{
				 intent1 = new Intent(PictureInfo.this,CommInfoActivity.class);
				 intent1.putExtra("btnvalue",getIntent().getIntExtra("btnvalue",0));
			}
...
private void commResultActivityFun(File dir,Bitmap bm){
		...
		if (Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)) {      
            ...
            mCurrentPhotoFile = new File(dir, getPhotoFileName());// 给新照的照片文件命名  
             can=new CanvasPhotoActivity(bm, mCurrentPhotoFile,PictureInfo.this,getIntent().getStringExtra("cameraPreviewdizhi"),PictureInfo.this);
            Thread thread = new Thread(can);
...
public boolean onKeyDown(int keyCode, KeyEvent event) {
	...
	case KeyEvent.KEYCODE_BACK:
		if(in == 81 || in == 82 || in == 83){
			intent1 = new Intent(this,ElectrolCarXian.class);
		}else if(in == 84){
			intent1 = new Intent(PictureInfo.this,ElectronCaiChan.class);
		}else{
			 intent1 = new Intent(this,CommInfoActivity.class);
			 intent1.putExtra("btnvalue",getIntent().getIntExtra("btnvalue",0));
		}
		startActivity(intent1);
		finish();
