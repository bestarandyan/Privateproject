...
public class ZoomImageView extends View implements Observer{
	...
	private void setZoomState(ZoomState mZoomState) {
        if (mState != null) {
...
//            mRectDst.left = viewWidth/2-bitmapWidth/2;
//            mRectDst.top = viewHeight/2-bitmapHeight/2;
//            mRectDst.right = width;
//            mRectDst.bottom = heigth;
//            mRectDst.right = viewWidth/2+bitmapWidth/2;
//            mRectDst.bottom = viewHeight/2+bitmapHeight/2;
...
//	    	Log.d("Zoom", "zoom f = " + f);
	    ...
	    private void limitZoom() {
	    	System.out.println(mState.getZoom()+"??????????????????"+MIN_ZOOM);
	...
	public void setZcontrols(ZoomControls zcontrols) {
		this.zoomcontrols = zcontrols;
