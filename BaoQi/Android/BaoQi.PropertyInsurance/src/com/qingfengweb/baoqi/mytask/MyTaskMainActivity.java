...
public class MyTaskMainActivity extends MapActivity{
	...
	private LinearLayout mainLayout;
	 ...
	 Button tvdetail,tvmap,tvaccept,tvchange,back_home;
	 private int[] accepteds=null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		map1.put("group", "上中路交通事故"); 
		map1.put("taskid", "12345");
		map1.put("name", "宁夏路交通事故");
		map1.put("type", "12");
		map1.put("accidenttime", "2012-3-3");
		map1.put("location", "宁夏路2222号");
		map1.put("longitude", "123.123");
		map1.put("latitude", "321.321");
		map1.put("reportname", "范爷");
		map1.put("phonenumber","18989882238");
		map1.put("comment","她是大腕明星，不要被她的气场压倒。。。。");
		map1.put("alloctatetime", "2012-3-3");
		map1.put("status", "6");
		map1.put("operator", "胡先生");
		Map<String,String> map2=new HashMap<String,String>();
		map2.put("group", "老沪闵路交通事故"); 
		map2.put("taskid", "12345");
		map2.put("name", "上中路老沪闵路交通事故");
		map2.put("type", "12");
		map2.put("accidenttime", "2012-3-3");
		map2.put("location", "上中西路老沪闵路");
		map2.put("longitude", "123.123");
		map2.put("latitude", "321.321");
		map2.put("reportname", "周董");
		map2.put("phonenumber","18989882239");
		map2.put("comment","他是中国著名歌唱家和演员，但绝对要公平处理。。。。");
		map2.put("alloctatetime", "2012-3-3");
		map2.put("status", "6");
		map2.put("operator", "毛警官");
		historyList.add(map1);
		historyList.add(map2);
	}
	private void initView(){
		back_home=(Button) findViewById(R.id.p_backhome_btn);
	...
	private void commonViewFun(){
		...
		back_home.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(MyTaskMainActivity.this,PropertyInsuranceMainActivity.class);
     ...
     */
     class AcceptTaskButtonListener implements View.OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			if(acceptTaskBtn.getText().equals("接受")){
			AlertDialog.Builder alert=new AlertDialog.Builder(MyTaskMainActivity.this);
	      	alert.setMessage("确定要接受？");
	      	...
	      	alert.setTitle("提示:").setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						// TODO Auto-generated method stub
						 ...
						 acceptTaskBtn.setText("查看详情");
	 					
	 					tvchange.setClickable(false);
						 tvchange.setEnabled(false);
						 tvchange.setTextColor(Color.GRAY);
			...
			}else if(acceptTaskBtn.getText().equals("查看详情")){
				rightLinearLayout.removeAllViews();
				 acceptFun();
				 rightLinearLayout.addView(acceptRelativeLayout);
			}
	...
	public class mytaskExpandableAdapter extends BaseExpandableListAdapter{ 
		  ...
		  */ 
		  ...
		  private void worningFun(final int tag1,final RelativeLayout rel){
			  AlertDialog.Builder alert=new AlertDialog.Builder(context);
		      	alert.setMessage("确定接受？");
		      	alert.setTitle("提示").setPositiveButton("确定", new DialogInterface.OnClickListener() {
		      			
						public void onClick(DialogInterface dialog, int which) {
							// TODO Auto-generated method stub
							 acceptedTaskInfoOfValuesFun(tag1);
				 			 acceptFun();
							 rightLinearLayout.removeAllViews();
							 accepteds[tag1] = 1;
							 tvaccept.setClickable(false);
							 ...
							 tvchange.setEnabled(false);
							 tvchange.setTextColor(Color.GRAY);
							 rightLinearLayout.addView(rel);
							 viewAdapter.notifyDataSetChanged();
							 /*ContentValues cv=new ContentValues();
							 cv.put("status", 1);
							 writeDB.update("currentTask", cv, "name=?", new String[]{groups.get(tag1).get("name").trim().toString()});
							 writeDB.close();*/
						}
					}).setNegativeButton("取消", new DialogInterface.OnClickListener() {
		  ...
		  tvdetail.setOnClickListener(new View.OnClickListener() {	
	 			...
	 			acceptFun();
	 			 for(int i=0;i<accepteds.length;i++){
	 				 if(tag==i){
	 					 if(accepteds[i] ==   1){
	 						acceptTaskBtn.setText("查看详情");
	 						/*rightButtonChange.setClickable(false);
		 					rightButtonChange.setEnabled(false);
		 					rightButtonChange.setTextColor(Color.GRAY);*/
		 					rightLinearLayout.addView (acceptRelativeLayout);
	 					 }else{
	 						acceptTaskBtn.setClickable(true);
	 						acceptTaskBtn.setEnabled(true);
	 						acceptTaskBtn.setTextColor(Color.BLACK);
		   ...
		   tvaccept.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					// TODO Auto-generated method stub
					int tag=Integer.parseInt(v.getTag().toString());
					// accepttag=Integer.parseInt(v.getTag().toString());
				     worningFun(tag,acceptRelativeLayout);
				}
			});
     ...
     */
      class CurrentButtonListener implements View.OnClickListener{
       ...
       class HistoryButtonListener implements View.OnClickListener{
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				viewAdapter = new mytaskExpandableAdapter(MyTaskMainActivity.this, historyList,childs); 
				   elvHistory.setAdapter(viewAdapter); 
