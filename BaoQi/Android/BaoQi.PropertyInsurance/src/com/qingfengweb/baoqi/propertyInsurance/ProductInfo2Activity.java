...
public class ProductInfo2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.l_productinfo2);
        ...
        homebtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
			  	intent.setClass(ProductInfo2Activity.this, PropertyInsuranceMainActivity.class);
		...
		btn1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(ProductInfo2Activity.this, CardBuyActivity.class);
				ProductInfo2Activity.this.startActivity(intent);
				ProductInfo2Activity.this.finish();
			}
		});
	...
	@Override
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event){
	  ...
	  if(KeyEvent.KEYCODE_BACK==keyCode){
		 Intent intent = new Intent();
		 intent.setClass(ProductInfo2Activity.this, ProductCenter2.class);
		 ProductInfo2Activity.this.startActivity(intent);
		 ProductInfo2Activity.this.finish();
	  }
	  return true;
