...
public class ProductAdapter extends BaseAdapter {
	...
	private class ViewHolder {
		...
		public void setContent(HashMap<String,Object> args,int position) {
			...
			btn1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					intent.setClass(context, FreeInsuranceActivity.class);
			...
			btn2.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					bundle.putInt("image", mThumbIds2[Integer.parseInt(v.getTag().toString())]
							);
		...
		private Integer[] mThumbIds2 = {
				R.drawable.ynzhywx01,R.drawable.jtywx01
				,R.drawable.banner_sub04,R.drawable.jczhx01
			};
	}
