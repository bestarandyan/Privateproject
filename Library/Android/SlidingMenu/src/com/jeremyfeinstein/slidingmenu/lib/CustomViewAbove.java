...
public class CustomViewAbove extends ViewGroup {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if(currentPage == 0 && x1>x2){
				return false;
			}else if(currentPage ==2 && x1<x2){
				return false;
	...
	public static boolean isHaveRight = false;//用来标记是否有右边页面
	@Override
...
//				if(scrollX>0){//控制右边侧栏的宽度
//					CustomViewBehind.mWidthOffset = 260;
//				}else{
//					CustomViewBehind.mWidthOffset = 60;
//				}
