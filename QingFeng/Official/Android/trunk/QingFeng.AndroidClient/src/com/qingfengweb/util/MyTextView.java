...
public class MyTextView extends TextView{
	...
	public MyTextView(Context context, AttributeSet attrs) {
		...
		textSize = attrs.getAttributeIntValue(namespace, "textSize", 40);
		...
		textShowWidth = MyApplication.getInstant().getScreenW() - paddingLeft - paddingRight - marginLeft - marginRight-40;
	}
	@Override
