	...
	public static void dealreponse(String reponse){
		if(reponse.contains("{")){
			...
			if (secretinfo != null) {
				...
				if(secretinfo.getClientkey()==null){
					System.out.println("secret_client---"+secretinfo.getClientkey());
				}
				
				if(secretinfo.getSystemkey()==null){
					System.out.println("secret_system---"+secretinfo.getSystemkey());
				}
				
				if(secretinfo.getUpdatetime()==null){
					System.out.println("secret_update_time---"+secretinfo.getUpdatetime());
				}
