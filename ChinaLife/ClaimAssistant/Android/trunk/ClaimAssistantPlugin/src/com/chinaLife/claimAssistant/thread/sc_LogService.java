 ...
 *  
 */  
public class sc_LogService extends Service {  
    ...
    {  
        createLogDir();  
        String logFileName = "client_"+sdf.format(new Date()) + ".log";// 日志文件名称  
    ...
    {  
        return fileName.substring(7, fileName.indexOf("."));  
    }  
