...
public class sc_AppInfo {
	...
	public static String TABLE_CREATE = "create table " + "appinfo" + // 表名
			...
			"version text," + // 当前版本号
			"url text," + // 版本信息下载地址
			"error_value text," + // 当前服务器时间
			"update_time text," + // 版本最后更新时间
			"lengend_update_time text," + // 图例最后更新时间
			"lengend_update_time1 text," + // 图例上一次更新时间
			"secret_update_time text," + // 密钥的更新时间
			"secret_system text," + // 服务端密钥
			"secret_client text," + // 客户端密钥
