...
public class Sc_ZoomImageView extends View implements Observer {
	...
	public Sc_ZoomImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.c = context;
	...
	public void setImage(Bitmap bitmap) {
		...
		mBitmap = bitmap;
		if (mBitmap == null) {
			Toast.makeText(c, "图片保存失败。。。", 5000).show();
		} else {
