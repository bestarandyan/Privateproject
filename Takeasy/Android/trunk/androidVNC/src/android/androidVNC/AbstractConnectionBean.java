...
public abstract class AbstractConnectionBean extends com.antlersoft.android.dbimpl.IdImplementationBase implements IConnectionBean {
    ...
    public static final String GEN_FIELD_DEFAULTCONNECTION = "DEFAULTCONNECTION";
    public static final int GEN_ID_DEFAULTCONNECTION = 21;
    ...
    private boolean gen_defaultconnection;
    ...
    public boolean getdefaultconnection() { return gen_defaultconnection; }
    public void setdefaultconnection(boolean arg_defaultconnection) { gen_defaultconnection = arg_defaultconnection; }
    ...
    public android.content.ContentValues Gen_getValues() {
        ...
        values.put(GEN_FIELD_DEFAULTCONNECTION,(this.gen_defaultconnection ? "1" : "0"));
        return values;
    }
    ...
    public int[] Gen_columnIndices(android.database.Cursor cursor) {
        ...
        result[21] = cursor.getColumnIndex(GEN_FIELD_DEFAULTCONNECTION);
        return result;
    }
    ...
    public void Gen_populate(android.database.Cursor cursor,int[] columnIndices) {
        ...
        if ( columnIndices[GEN_ID_DEFAULTCONNECTION] >= 0 && ! cursor.isNull(columnIndices[GEN_ID_KEEPPASSWORD])) {
            gen_defaultconnection = (cursor.getInt(columnIndices[GEN_ID_DEFAULTCONNECTION]) != 0);
        }
    }
    ...
    public void Gen_populate(android.content.ContentValues values) {
        ...
        //gen_colorModel=COLORMODEL.C24bit.nameString();
        ...
        gen_defaultconnection = (values.getAsInteger(GEN_FIELD_DEFAULTCONNECTION) != 0);
    }
}
