...
public class RfbProto {
  ...
  String host;
  int port;
  Socket sock;  //通信socket
  DataInputStream is; //获取server输入流
  OutputStream os;//本地输出流
 ...
 public int framebufferWidth, framebufferHeight;
  ...
  void readServerInit() throws IOException {
	...
	MyApplication.getInstance().setmCHeight(framebufferHeight);
	MyApplication.getInstance().setmCWidth(framebufferWidth);
