		...
		menu.findItem(R.id.itemDeleteKeyList).setOnMenuItemClickListener(
				new MenuItem.OnMenuItemClickListener() {
					...
					public boolean onMenuItemClick(MenuItem item) {
				    	Utils.showYesNoPrompt(_canvasActivity, "É¾³ý¼üÁÐ±í",
				    			"É¾³ýÁÐ±í "+_textListName.getText().toString(),
				    			new OnClickListener() {
				...
				new MenuItem.OnMenuItemClickListener() {
					...
					public boolean onMenuItemClick(MenuItem item) {
				    	...
				    	if (position != Spinner.INVALID_POSITION)
				    	{
					    	...
					    	Utils.showYesNoPrompt(_canvasActivity, "É¾³ýÁÐ±í",
					    			"É¾³ý¼ü " + toDelete.getKeyDesc(),
					    			new OnClickListener() {
