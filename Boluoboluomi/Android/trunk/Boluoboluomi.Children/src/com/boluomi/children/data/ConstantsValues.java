...
public class ConstantsValues {
	...
	public static final String SAVE_PATH_IN_SDCARD = "/boluomi_children/"; //图片及其他数据保存文件夹   
	public static final String SDCARD_ROOT_PATH = Environment.getExternalStorageDirectory().getAbsolutePath();//路径   
