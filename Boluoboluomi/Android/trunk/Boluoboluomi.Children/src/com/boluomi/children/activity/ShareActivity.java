...
public class ShareActivity extends Activity implements android.view.View.OnClickListener {
	/**
	 * author by Ring
	 * 用于分享微博功能
	 */
...
//		button_zhuxiao.setOnClickListener(this);
	...
	public void initData(){
		...
		}else if(type == ConstantsValues.SMS_TYPE){
			SMSShare shareSDK = new SMSShare(this);
			shareSDK.startSMSShare(msgContent, picPath);
			title.setText("短信分享");
		}else if(type == ConstantsValues.EMAIL_TYPE){
