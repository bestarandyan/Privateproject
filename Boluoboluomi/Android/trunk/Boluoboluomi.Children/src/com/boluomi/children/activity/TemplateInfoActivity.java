...
//	}
	...
	public void onClick(View v) {
		if (v == backBtn) {
			...
			bundle.putString("shouyaoName", shouyaoName.getText().toString());
			bundle.putString("xinlangName", xinlangName.getText().toString());
			bundle.putString("xinniangName", xinniangName.getText().toString());
			bundle.putString("year", year.getText().toString());
			bundle.putString("month", month.getText().toString());
			bundle.putString("ri", ri.getText().toString());
			// if(xingqiLinear.isShown()){
			bundle.putString("week", week.getText().toString());
			// }
			// if(longliLinear.isShown()){
			bundle.putString("longliyue", longliyue.getText().toString());
			bundle.putString("longliri", longliri.getText().toString());
			// }
			// if(shijianLinear.isShown()){
			bundle.putString("shijian", shijian.getText().toString());
			// }
			// if(dianmingLinear.isShown()){
			bundle.putString("dianming", dianming.getText().toString());
			// }
	 ...
	 */
	    ...
	    */
	    private void setDateView(){ 
	    	...
	    	ri.setText(cal.get(Calendar.DAY_OF_MONTH)+"");
	    } 
	    /**
	     * 设置事件控件值
	     */
	    private void setTimeView(){
	    	shijian.setText(cal.get(Calendar.HOUR_OF_DAY)+":"+cal.get(Calendar.MINUTE));
	    }
