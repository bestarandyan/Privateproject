...
import com.qingfengweb.util.ChinaDate;
...
//	            }
	    ...
	    */
	    private void setDateView(){ 
	    	...
	    	String[] yingli = ChinaDate.getYingLi(Integer.parseInt(year.getText().toString()), 
	    			Integer.parseInt(month.getText().toString()), Integer.parseInt(ri.getText().toString()));
	    	longliyue.setText(yingli[0]);
	    	longliri.setText(yingli[1]);
	    	
	    	week.setText(ChinaDate.getXingQi(Integer.parseInt(year.getText().toString()), 
	    			Integer.parseInt(month.getText().toString()), Integer.parseInt(ri.getText().toString())));
	    } 
	    /**
	     * 设置事件控件值
