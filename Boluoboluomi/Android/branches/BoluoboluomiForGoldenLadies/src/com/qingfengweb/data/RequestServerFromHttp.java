...
//	public static final String SERVER_ADDRESS = "http://192.168.1.114:1367";//内网服务器总接口地址
	public static final String SERVER_ADDRESS = "http://api.91blm.com:99";//外网服务器总接口地址
	...
	public static final String INTERFACE_INVITATION = SERVER_ADDRESS+"/interfaces/invitation.aspx";//电子请帖接口。
	...
	public static final String ACTION_SETUSERHEADIMG = "set_photo_cover";//设置用户头像动作
	...
	public static final String ACTION_MERCHAN_PRODUCT = "product";//商家产品列表
	...
	public static final String ACTION_INVITATION_LIST = "list";//获取电子模板列表数据
	public static final String ACTION_INVITATION_DOWNLOAD = "download";//下载电子模板
	/**
	 * 图片下载
	 * @param context 
	...
	public static int downloadInvitation(Context context,String templateid,String filePath,String fileName){
		...
		list.add(new BasicNameValuePair("action", ACTION_INVITATION_DOWNLOAD));
		list.add(new BasicNameValuePair("templateid", templateid));
		FileDownload fileDownload = new FileDownload();
		return fileDownload.downloadFileFromId(context, INTERFACE_INVITATION, list, filePath, fileName);
	}
	/**
     * 获取电子模板数据
     * @return
     */
 	public static String getInvitationList(String updatetime){
 		String msgString = "";
 		List<NameValuePair> params = new ArrayList<NameValuePair>();
 		params.add(new BasicNameValuePair("appid", APPID));
 		params.add(new BasicNameValuePair("appkey", APPKEY));
 		params.add(new BasicNameValuePair("action", ACTION_INVITATION_LIST));
 		params.add(new BasicNameValuePair("storeid", UserBeanInfo.getInstant().getCurrentStoreId()));
 		params.add(new BasicNameValuePair("updatetime", updatetime));
 		msgString = getData(INTERFACE_INVITATION, params);
 		return msgString;
 	}
    ...
    */
	 ...
	 * @return
	 */
	public static String setUserHeadImg(String username,String password,String photoid){
		String msgString = "";
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("appid", APPID));
		params.add(new BasicNameValuePair("appkey", APPKEY));
		params.add(new BasicNameValuePair("action", ACTION_SETUSERHEADIMG));
		params.add(new BasicNameValuePair("username", username));
		params.add(new BasicNameValuePair("password", password));
	 ...
	 * @return
	 */
	public static String getMerchanProductList(String storeid,String providerid,String updatetime){
		String msgString = "";
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("appid", APPID));
		params.add(new BasicNameValuePair("appkey", APPKEY));
		params.add(new BasicNameValuePair("action", ACTION_MERCHAN_PRODUCT));
		params.add(new BasicNameValuePair("storeid", storeid));
	 ...
	 * @param height
	 */
	public static void downImageForUrl(Context context,ImageView imageView,int defId,String imageUrl,String toSD,boolean height){
		CallbackImpl callbackImpl = new CallbackImpl(context,imageView);
		ImageLoadFromUrlOrId imageLoad = new ImageLoadFromUrlOrId();
		imageLoad.loadImageFromUrl(context, defId, imageUrl, toSD, callbackImpl, height, MyApplication.getInstant().getWidthPixels());
	}
