...
public class ListDispose {
	 ...
	 * @return 按拼音排序后的集合
	 */
	public static ArrayList<HashMap<String, String>> sortList1(ArrayList<HashMap<String, String>> list,ArrayList<String> zimulist,String str) {
		ArrayList<HashMap<String, String>> newList = new ArrayList<HashMap<String, String>>();//新的集合
		Comparator<Object> cmp = Collator.getInstance();
