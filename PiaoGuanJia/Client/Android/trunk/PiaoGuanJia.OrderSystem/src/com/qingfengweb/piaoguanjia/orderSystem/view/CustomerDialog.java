...
public class CustomerDialog extends Dialog {
	...
	public static class Builder {
		...
		public Builder setIcon(int icMenuQuestion) {
			this.icon = icMenuQuestion;
			return this;
		}
		...
		public CustomerDialog create() {
			...
			if (positiveButtonText != null) {
				...
				layout.findViewById(R.id.btn1).setVisibility(View.GONE);
			}
			...
			if (negativeButtonText != null) {
				...
				// if no confirm button just set the visibility to GONE
				layout.findViewById(R.id.btn2).setVisibility(View.GONE);
			}
			...
			if (message != null) {
				...
				((LinearLayout) layout.findViewById(R.id.tv_content))
						.removeAllViews();
				((LinearLayout) layout.findViewById(R.id.tv_content)).addView(
