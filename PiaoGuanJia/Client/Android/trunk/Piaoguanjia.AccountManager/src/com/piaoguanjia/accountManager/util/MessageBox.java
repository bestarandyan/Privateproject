package com.piaoguanjia.accountManager.util;
...
public class MessageBox {
	 ...
	 * */
	public static Dialog CreateAlertDialog1(String msg,Context context )
	{
...
//		       .setCancelable(false)
	 ...
	 * conntext ：Activity </br>
	 * */
	public static Dialog createAlertDialog(String msg, String btnname,Context context )
	{
		AlertDialog.Builder builder = new AlertDialog.Builder(context);
		builder.setMessage(msg)
		.setTitle("提示")
...
//		       .setCancelable(false)
	...
	public static void CreateAlertDialog1(SpannableString ss,Context context )
	{
		AlertDialog.Builder builder = new AlertDialog.Builder(context);
...
//	     final View textEntryView = factory.inflate(R.layout.alert_dialog_text_entry, null);
	     return new AlertDialog.Builder(context).setTitle("提示").setView(views).create();
