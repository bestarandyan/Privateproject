...
import com.qingfengweb.piaoguanjia.db.LoginBean;
...
public class GetTicket {
	...
	public String getTicket(String idnumner,String action){
		   String taskStr = null;
			// 2. 使用 Apache HTTP 客户端实现
	...
	public Map<String,String> jsonGetTicket(String msg){
	    ...
	    TicketBean user=gson.fromJson(msg, TicketBean.class); 
		  	...
		  	map.put("validatetime", user.getValidatetime());
		return map;
	}
	public Bundle jsonGetTicketToBundle(String msg){
	    ...
	    bundle.putString("validatetime", user.getValidatetime());
		return bundle;
	}
	public Bundle jsonLoginToBundle(String msg){
		Bundle bundle = new Bundle();
		Gson gson=new Gson();  
		LoginBean user=gson.fromJson(msg, LoginBean.class); 
	    bundle.putString("userid", user.getUserid());
	    bundle.putString("exitpassword", user.getExitpassword());
		return bundle;
	}
...
//		if(C.getCount()==0){
			...
			cv.put("validatetime", map.get("validatetime"));
